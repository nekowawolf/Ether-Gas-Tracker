import { AddressEventNotificationChain, JsonRpcCall, JsonRpcResponse, Network, QueryParams } from '../dto';
...
export declare const Utils: {
    ...
    addQueryParams: (basePath: string, strategy: (key: string) => string, queryParams?: QueryParams) => string;
};
