...
const testNetworks = [
    ...
    { network: dto_1.Network.ARBITRUM_ONE },
    { network: dto_1.Network.ARBITRUM_NOVA, apiKey: process.env.V3_API_KEY_MAINNET },
    {
    ...
    { network: dto_1.Network.FLARE_COSTON },
    ...
    { network: dto_1.Network.FANTOM },
    { network: dto_1.Network.FANTOM_TESTNET, apiKey: process.env.V3_API_KEY_TESTNET },
    { network: dto_1.Network.ETHEREUM_CLASSIC },
    { network: dto_1.Network.POLYGON },
    { network: dto_1.Network.POLYGON_MUMBAI },
    ...
    { network: dto_1.Network.CRONOS },
    { network: dto_1.Network.CRONOS_TESTNET, apiKey: process.env.V3_API_KEY_TESTNET },
