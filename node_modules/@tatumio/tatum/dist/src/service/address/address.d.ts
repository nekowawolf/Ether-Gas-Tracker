...
export declare class Address {
     ...
     */
    getBalance({ page, pageSize, addresses, }: AddressBalanceFilters): Promise<ResponseDto<AddressBalance[]>>;
    /**
     * Get all transactions, that are related to the given address. It could be both incoming and outgoing transactions.
     */
    getTransactions({ address, transactionDirection, transactionTypes, fromBlock, toBlock, pageSize, page, tokenAddress, }: GetAddressTransactionsQuery): Promise<ResponseDto<AddressTransaction[]>>;
