...
class AbstractAlgorandAlgodRpc {
    sendPost({ path, body, queryParams, }) {
        const post = {
            path: util_1.Utils.addQueryParams(path, util_1.Utils.camelToDashCase, queryParams),
        };
        if (body) {
    ...
    async sendGet({ path, queryParams }) {
        return this.get({ path: util_1.Utils.addQueryParams(path, util_1.Utils.camelToDashCase, queryParams) });
    }
